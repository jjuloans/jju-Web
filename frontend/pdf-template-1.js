...
function buildHTMLPage(txType, data) {
  ...
  if (internalBankTypes.includes(txType)) {
    ...
    return bankTRFVoucherPage(intRows, dtFmt);
  }
...
function naammatr_FormPage(nm, addr, dtFmt, dob, shrAcc, ref, docPhotos) {
  ...
  // Applicant signature
  var sigAppl =
    '<div style="display:flex;justify-content:flex-end;padding:14px 20px 10px;border-bottom:1.5px dashed #aaa">' +
    '<div style="text-align:center">' +
    sigLine(nm, "अर्जदाराची सही") +
    "</div>" +
    "</div>";
  ...
  var officerRow =
    ...
    "</strong></div>" +
    '<div style="text-align:center">' +
    '<div style="border-bottom:1px solid #000;height:18px;min-width:50mm;margin-top:8px;margin-bottom:4px"></div>' +
  ...
  var authSig =
    ...
    '<div style="text-align:center">' +
    '<div style="border-bottom:1px solid #000;height:18px;min-width:55mm;margin-top:8px;margin-bottom:4px"></div>' +
...
function naammatr_SlipsPage(nm, dtFmt, savAcc, shrAcc) {
  ...
  // Slip 3: SAV-DEPOSIT — saving deposit slip (proper sblock structure)
  var slip3 =
    '<div class="sblock" style="page-break-inside:avoid;margin-bottom:4px">' +
    orgHdr() +
    '<div class="stbar"><span>प्रवेश फि / स्टेशनरी / लघुबचत / मुदत ठेव / <u>बचत ठेव</u> / सभासद ठेव / नाममात्र सदस्य फि</span><span class="scode">SAV - CR &nbsp; Credit</span></div>' +
    '<table class="sst"><tr>' +
    '<th style="width:15%">Scroll No</th>' +
    '<th style="width:22%">नाममात्र खाते क्र.</th>' +
    '<th style="width:22%">बचत खाते क्र.</th>' +
    '<th style="width:28%">तारीख</th>' +
    ...
    "</tr></table>" +
    '<table class="sct compact-slip">' +
    '<tr><th class="sl" style="background:#e8f5e9;width:38%">खातेदाराचे नाव</th><td class="sv" style="font-size:10pt;font-weight:800" colspan="3">' +
    nm +
    "</td></tr>" +
    '<tr><th class="sl" style="background:#e8f5e9">रक्कम</th>' +
    '<td class="sv" colspan="3"><strong>रक्कम रू. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; /-</strong> <span style="font-size:9pt;font-weight:600">(अक्षरी रू. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;)</span></td>' +
    "</tr>" +
    '<tr><th class="sl" style="background:#e8f5e9;font-size:8.5pt">Transfer</th><td class="sv" colspan="3" style="font-size:8.5pt;color:#555">Naammatr Account → Saving Account (बचत जमा)</td></tr>' +
    "</table>" +
    '<div class="sftr" style="margin-top:2px">' +
    '<div class="si"><span class="si-name" style="font-size:7pt">रोखपाल/व्यवस्थापक/अधिकारी</span></div>' +
    '<div class="si"><span class="si-name" style="font-size:7pt">' +
    nm +
    "</span></div>" +
    "</div>" +
